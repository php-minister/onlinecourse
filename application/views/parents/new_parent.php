<script>
    $('document').ready(function(){
        ...
        $('#children').magicSuggest(magic_suggest_options({data:'students/find_student',name:'children_list'}));
    })
</script>
<div class="modal show">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3><?= $this->lang->line('new_parent')?></h3>
    </div>
        ...
        <form action="parents/save_parent" method="POST" id="person_form">
            ...
            <div class="pull-left">
                <div class="pull-left control-group margin_right_10">
                        ...
                        <input type="text" name="parent_name" id="parent_name" maxlength="150" class="required">
                </div>
