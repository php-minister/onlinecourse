<script>
    ...
    $('document').ready(function(){
        ...
        students=$('#chosen_students').magicSuggest(magic_suggest_options({data:'students/find_student',name:'chosen_students'}));
    })
</script>
    ...
    <div class="modal-body">
        ...
        <form action="public_scheduling/save_lesson" method="POST" id="lesson_form">
            ...
            <div class="control-group pull-left margin_right_10">
                ...
                <?php if (count($subjects['subjects'])==0){?>
                <?= $this->lang->line('no_subjects_for_this_teacher')?>
                <?php }else{?>
            ...
            <div class="pull-left">
                <label>&nbsp;</label>
                <button type="button" onclick="load_classrooms();" class="btn btn-success"><?= $this->lang->line('find_classrooms')?></button>
            </div>
            <div class="clearfix"></div>
        </form>
    </div>
