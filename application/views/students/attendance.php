            ...
            <div class="custom-header">
                <h3 class="custom-month-year">
                    ...
                    <nav>
                        ...
                        <a href="students/attendance/<?= $student_id?>?pdf&month=<?= date('m-Y')?>" target="_blank" id="download_pdf" title="<?= $this->lang->line('download_pdf')?>" onclick="$(this).attr('href','students/attendance/<?= $student_id?>?pdf&month='+calendar.getMonth()+'-'+calendar.getYear())"><img src="images/pdf.png"></a>
                    </nav>
                </h3>
