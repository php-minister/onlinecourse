...
<div class="modal show">
    <div class="modal-header">
        ...
        <h3><?= $this->lang->line('new_teacher')?></h3>
    </div>
        ...
        <form action="teachers/save_teacher" method="POST" id="person_form">
            ...
            <div class="pull-left margin_right_10" style="background-image: url('<?= DEFAULT_PHOTO?>');" id="user_avatar_image">
                <div id="person_photo_area">
                    ...
                    <button type="button" class="btn btn-mini hide pull-left" title="Remove photo" id="remove_photo"><i class="icon-remove"></i></button>
            ...
            <div class="pull-left">
                <div class="pull-left control-group margin_right_10">
                        ...
                        <input type="text" name="teacher_name" id="teacher_name" maxlength="150" class="required">
                </div>
                ...
                <div class="pull-left control-group margin_right_10">
                    ...
                    <input type="text" name="ssn" id="ssn" maxlength="20" class="input-medium">
                </div>
                <div  class="pull-left control-group">
