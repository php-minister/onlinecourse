<script>
    $('document').ready(function(){
        ...
        $('#student').magicSuggest(magic_suggest_options({data:'students/find_student',name:'student_list'}));
        $('#reported').magicSuggest(magic_suggest_options({data:'teachers/find_teacher',name:'teacher_list'}));
    })
</script>
