<script>
    ...
    $('document').ready(function(){
        ...
        students=$('#chosen_students')
                    .magicSuggest(magic_suggest_options({data:'teacher/find_student',name:'chosen_students'}));
...
<div class="modal show">
    <div class="modal-header">
        ...
        <h3><?= $this->lang->line('edit_lesson')?></h3>
    </div>
    <div class="modal-body">
        ...
        <form action="public_scheduling/save_lesson" method="POST" id="lesson_form">
            ...
            <div class="control-group">
                ...
                <input type="text" id="start_date" name="start_date" value="<?= date('m/d/Y',strtotime($lesson['date']))?>" class="required">
                <?php }else{?>
            ...
            <div class="control-group">
                ...
                <button type="button" onclick="load_classrooms('teacher');" class="btn btn-success <?= ($lesson['allow_to_edit']=='0')?'disabled':''?>" <?= ($lesson['allow_to_edit']=='0'?'disabled="disabled"':'')?>><?= $this->lang->line('find_classrooms')?></button>
            </div>
        </form>
    </div>
