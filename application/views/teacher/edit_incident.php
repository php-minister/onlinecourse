<script>
    $('document').ready(function(){
        ...
        $('#student')
            .magicSuggest(magic_suggest_options({data:'teacher/find_student',name:'student_list'}))
...
<div class="modal show">
    <div class="modal-header">
        ...
        <h3><?= $this->lang->line('edit_incident')?></h3>
    </div>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="details_tab">
                   ...
                   <div class="control-group">
                        ...
                        <input type="text" name="date" id="date" class="required" maxlength="20" value="<?= date('m/d/Y',strtotime($incident['date']))?>">
                    </div>
                   <div class="control-group">
                        <label for="details"><?= $this->lang->line('details')?><sup class="mandatory">*</sup></label>
                        <textarea rows="2" name="details" id="details" class="required span12"><?= $incident['details']?></textarea>
                    </div>
                </div>
                <div class="tab-pane" id="taken_actions_tab">
                    ...
                    <div class="control-group">
                        ...
                        <textarea rows="2" name="response" id="response" class="span12"><?= $incident['response']?></textarea>
                    </div>
                </div>
            </div>
        </form>
