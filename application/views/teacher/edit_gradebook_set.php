...
<div class="modal show">
    ...
    <div class="modal-body">
        ...
        <form action="teacher/save_gradebook_set" method="POST" id="set_form">
            ...
            <div class="control-group pull-left margin_right_10">
                ...
                <input type="text" name="name" id="name" class="required" maxlength="100" value="<?= $set['name']?>">
            </div>
            <div class="control-group pull-left">
                <label for="date"><?= $this->lang->line('assignment_date')?><sup class="mandatory">*</sup></label>
                <input type="text" name="date" id="date" class="required" value="<?= date('m/d/Y',strtotime($set['date']))?>">
            </div>
