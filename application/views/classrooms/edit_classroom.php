<div class="modal show">
    <div class="modal-header">
        ...
        <h3><?= $this->lang->line('edit_classroom')?></h3>
    </div>
    <div class="modal-body">
        <div id="save_result"></div>
        <form action="classrooms/save_classroom" method="POST" id="classroom_form">
            <input type="hidden" name="classroom_id" id="classroom_id" value="<?= $classroom['room_id']?>">
            <div class="control-group">
                <label for="name"><?= $this->lang->line('classroom_name')?><sup class="mandatory">*</sup></label>
                <input type="text" name="name" id="name" maxlength="50" class="required" value="<?= $classroom['name']?>">
            </div>
            <div class="control-group">
                <label>
                    <input type="checkbox" name="is_shared" id="is_shared" <?= ($classroom['is_shared']=='1')?'checked="checked"':''?>><?= $this->lang->line('is_shared')?>
                </label>
            </div>
        </form>
    </div>
